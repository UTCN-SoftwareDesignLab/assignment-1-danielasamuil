...
public class ClientServiceImplTest {
    ...
    public void testFindById() throws EntityNotFoundException {
        ...
        Notification<Boolean> res = service.save(client.getId(),client.getName(),client.getIdentityCardNumber(),client.getAddress(),client.getPersonalNumericalCode(), null);
    ...
    public void testRemove() {
        Client client = new ClientBuilder().setName("Daniela").setAddress("strada Viitorului").setIdentityCardNumber(11111111).setPersonalNumericalCode("2990616125111").build();
        service.update(client.getId(),client.getName(),client.getIdentityCardNumber(),client.getAddress(),client.getPersonalNumericalCode(), null);
    ...
    public void testRemoveAll() {
        Client client = new ClientBuilder().setName("Daniela").setAddress("strada Viitorului").setIdentityCardNumber(11111111).setPersonalNumericalCode("2990616125111").build();
        service.save(client.getId(),client.getName(),client.getIdentityCardNumber(),client.getAddress(),client.getPersonalNumericalCode(), null);
        service.removeAll();
